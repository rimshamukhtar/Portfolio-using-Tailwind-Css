...
const About = () => {
  return (
    <section className="flex justify-center items-center h-auto sm:h-96 bg-gray-900 px-4">
      <div className="w-full max-w-lg text-center text-zinc-500 font-serif p-4">
        ...
        <button className="text-gray-300 bg-gradient-to-br from-cyan-600 via-cyan-700 border-2 w-full sm:w-32 mt-4 rounded-lg font-bold p-1 border-cyan-800">
